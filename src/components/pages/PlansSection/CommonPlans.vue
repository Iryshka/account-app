...
<!--    <plans-dropdown-select :options="options" />-->
<!--        <ul class="plans__buttons">-->
<!--          <li class="plans__button">-->
<!--            <default-button-->
<!--              v-for="(label, index) in buttonLabel"-->
<!--              :key="index"-->
<!--              theme="primary"-->
...
<!--import { ref } from 'vue'-->
<!--import DropdownSelect from '@/components/pages/PlansSection/PlansDropdownSelect.vue'-->
